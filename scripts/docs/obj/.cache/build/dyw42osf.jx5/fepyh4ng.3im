...
<html>
  ...
  <div class="markdown level1 summary"><p sourcefile="../../obj/api/Microsoft.MixedReality.Toolkit.Input.SimulatedHandUtils.yml" sourcestartlinenumber="2">Compute the rotation of each joint, with the forward vector of the rotation pointing along the joint bone,
and the up vector pointing up.</p>
<p sourcefile="../../obj/api/Microsoft.MixedReality.Toolkit.Input.SimulatedHandUtils.yml" sourcestartlinenumber="5">The rotation of the base joints (thumb base, pinky base, etc) as well as the wrist joint is set to
point in the direction of palm forward.</p>
<p sourcefile="../../obj/api/Microsoft.MixedReality.Toolkit.Input.SimulatedHandUtils.yml" sourcestartlinenumber="8">Assumption: the position of each joint has been copied from handData joint positions</p>
</div>
  ...
  <div class="markdown level1 summary"><p sourcefile="../../obj/api/Microsoft.MixedReality.Toolkit.Input.SimulatedHandUtils.yml" sourcestartlinenumber="2">Gets vector corresponding to +z.</p>
</div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="decalaration">Declaration</h5>
  <div class="codewrapper">
  ...
  <div class="markdown level1 summary"><p sourcefile="../../obj/api/Microsoft.MixedReality.Toolkit.Input.SimulatedHandUtils.yml" sourcestartlinenumber="2">Gets the vector corresponding to +y.</p>
</div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="decalaration">Declaration</h5>
  <div class="codewrapper">
