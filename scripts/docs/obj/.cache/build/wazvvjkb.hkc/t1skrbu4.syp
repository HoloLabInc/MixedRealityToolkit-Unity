...
<html>
  ...
  <head>
    ...
    <title>Interface IMixedRealityCameraSystem
   | Mixed Reality Toolkit Documentation </title>
    <meta name="viewport" content="width=device-width">
    <meta name="title" content="Interface IMixedRealityCameraSystem
    ...
    <div id="wrapper">
      ...
      <div role="main" class="container body-content hide-when-search">
        ...
        <div class="article row grid-right">
          <div class="col-md-10">
            <article class="content wrap" id="_content" data-uid="Microsoft.MixedReality.Toolkit.CameraSystem.IMixedRealityCameraSystem">
  
  
  <h1 id="Microsoft_MixedReality_Toolkit_CameraSystem_IMixedRealityCameraSystem" data-uid="Microsoft.MixedReality.Toolkit.CameraSystem.IMixedRealityCameraSystem" class="text-break">Interface IMixedRealityCameraSystem
  </h1>
  <div class="markdown level0 summary"><p sourcefile="../../obj/api/Microsoft.MixedReality.Toolkit.CameraSystem.IMixedRealityCameraSystem.yml" sourcestartlinenumber="2">Manager interface for a camera system in the Mixed Reality Toolkit.
The camera system is expected to manage settings on the main camera.
It should update the camera's clear settings, render mask, etc based on platform.</p>
</div>
  ...
  <h6><strong>Namespace</strong>: <a class="xref" href="Microsoft.MixedReality.Toolkit.CameraSystem.html">Microsoft.MixedReality.Toolkit.CameraSystem</a></h6>
  <h6><strong>Assembly</strong>: cs.temp.dll.dll</h6>
  <h5 id="Microsoft_MixedReality_Toolkit_CameraSystem_IMixedRealityCameraSystem_syntax">Syntax</h5>
  <div class="codewrapper">
    <pre><code class="lang-csharp hljs">public interface IMixedRealityCameraSystem : IMixedRealityEventSystem, IMixedRealityEventSource, IEqualityComparer, IMixedRealityService, IDisposable</code></pre>
  </div>
  <h3 id="properties">Properties
  </h3>
  
  
  <a id="Microsoft_MixedReality_Toolkit_CameraSystem_IMixedRealityCameraSystem_CameraProfile_" data-uid="Microsoft.MixedReality.Toolkit.CameraSystem.IMixedRealityCameraSystem.CameraProfile*"></a>
  <h4 id="Microsoft_MixedReality_Toolkit_CameraSystem_IMixedRealityCameraSystem_CameraProfile" data-uid="Microsoft.MixedReality.Toolkit.CameraSystem.IMixedRealityCameraSystem.CameraProfile">CameraProfile</h4>
  <div class="markdown level1 summary"><p sourcefile="../../obj/api/Microsoft.MixedReality.Toolkit.CameraSystem.IMixedRealityCameraSystem.yml" sourcestartlinenumber="2">Typed representation of the ConfigurationProfile property.</p>
</div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="decalaration">Declaration</h5>
  <div class="codewrapper">
    <pre><code class="lang-csharp hljs">MixedRealityCameraProfile CameraProfile { get; }</code></pre>
  </div>
  ...
  <table class="table table-bordered table-striped table-condensed">
    ...
    <tbody>
      <tr>
        <td><a class="xref" href="Microsoft.MixedReality.Toolkit.MixedRealityCameraProfile.html">MixedRealityCameraProfile</a></td>
        <td></td>
      </tr>
    </tbody>
  </table>
  ...
  <a id="Microsoft_MixedReality_Toolkit_CameraSystem_IMixedRealityCameraSystem_IsOpaque_" data-uid="Microsoft.MixedReality.Toolkit.CameraSystem.IMixedRealityCameraSystem.IsOpaque*"></a>
  <h4 id="Microsoft_MixedReality_Toolkit_CameraSystem_IMixedRealityCameraSystem_IsOpaque" data-uid="Microsoft.MixedReality.Toolkit.CameraSystem.IMixedRealityCameraSystem.IsOpaque">IsOpaque</h4>
  <div class="markdown level1 summary"><p sourcefile="../../obj/api/Microsoft.MixedReality.Toolkit.CameraSystem.IMixedRealityCameraSystem.yml" sourcestartlinenumber="2">Is the current camera displaying on an opaque (VR / immersive) or a transparent (AR) device</p>
</div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="decalaration">Declaration</h5>
  <div class="codewrapper">
    <pre><code class="lang-csharp hljs">bool IsOpaque { get; }</code></pre>
  </div>
  <h5 class="propertyValue">Property Value</h5>
  <table class="table table-bordered table-striped table-condensed">
    <thead>
