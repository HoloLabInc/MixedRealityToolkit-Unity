...
<html>
  ...
  <head>
    ...
    <title>Class BaseCoreSystem
   | Mixed Reality Toolkit Documentation </title>
    <meta name="viewport" content="width=device-width">
    <meta name="title" content="Class BaseCoreSystem
    ...
    <div id="wrapper">
      ...
      <div role="main" class="container body-content hide-when-search">
        ...
        <div class="article row grid-right">
          <div class="col-md-10">
            <article class="content wrap" id="_content" data-uid="Microsoft.MixedReality.Toolkit.BaseCoreSystem">
  
  
  <h1 id="Microsoft_MixedReality_Toolkit_BaseCoreSystem" data-uid="Microsoft.MixedReality.Toolkit.BaseCoreSystem" class="text-break">Class BaseCoreSystem
  </h1>
  ...
  <div class="inheritance">
    ...
    <div class="level3"><span class="xref">BaseCoreSystem</span></div>
      ...
      <div class="level4"><a class="xref" href="Microsoft.MixedReality.Toolkit.Boundary.BaseBoundarySystem.html">BaseBoundarySystem</a></div>
      <div class="level4"><a class="xref" href="Microsoft.MixedReality.Toolkit.Diagnostics.MixedRealityDiagnosticsSystem.html">MixedRealityDiagnosticsSystem</a></div>
      <div class="level4"><a class="xref" href="Microsoft.MixedReality.Toolkit.Input.DefaultRaycastProvider.html">DefaultRaycastProvider</a></div>
      <div class="level4"><a class="xref" href="Microsoft.MixedReality.Toolkit.Input.FocusProvider.html">FocusProvider</a></div>
      <div class="level4"><a class="xref" href="Microsoft.MixedReality.Toolkit.SceneSystem.MixedRealitySceneSystem.html">MixedRealitySceneSystem</a></div>
      <div class="level4"><a class="xref" href="Microsoft.MixedReality.Toolkit.Teleport.MixedRealityTeleportSystem.html">MixedRealityTeleportSystem</a></div>
  </div>
  ...
  <h5 id="Microsoft_MixedReality_Toolkit_BaseCoreSystem_syntax">Syntax</h5>
  <div class="codewrapper">
    <pre><code class="lang-csharp hljs">public abstract class BaseCoreSystem : BaseEventSystem, IMixedRealityEventSystem, IMixedRealityService, IDisposable</code></pre>
  </div>
  <h3 id="constructors">Constructors
  </h3>
  
  
  <a id="Microsoft_MixedReality_Toolkit_BaseCoreSystem__ctor_" data-uid="Microsoft.MixedReality.Toolkit.BaseCoreSystem.#ctor*"></a>
  <h4 id="Microsoft_MixedReality_Toolkit_BaseCoreSystem__ctor_Microsoft_MixedReality_Toolkit_BaseMixedRealityProfile_" data-uid="Microsoft.MixedReality.Toolkit.BaseCoreSystem.#ctor(Microsoft.MixedReality.Toolkit.BaseMixedRealityProfile)">BaseCoreSystem(BaseMixedRealityProfile)</h4>
  <div class="markdown level1 summary"><p sourcefile="../../obj/api/Microsoft.MixedReality.Toolkit.BaseCoreSystem.yml" sourcestartlinenumber="2">Constructor.</p>
</div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="decalaration">Declaration</h5>
  <div class="codewrapper">
    <pre><code class="lang-csharp hljs">protected BaseCoreSystem(BaseMixedRealityProfile profile = null)</code></pre>
  </div>
  ...
  <table class="table table-bordered table-striped table-condensed">
    ...
    <tbody>
      <tr>
        ...
        <td><p sourcefile="../../obj/api/Microsoft.MixedReality.Toolkit.BaseCoreSystem.yml" sourcestartlinenumber="1">The configuration profile for the service.</p>
</td>
      </tr>
    </tbody>
  </table>
  ...
  <a id="Microsoft_MixedReality_Toolkit_BaseCoreSystem__ctor_" data-uid="Microsoft.MixedReality.Toolkit.BaseCoreSystem.#ctor*"></a>
  <h4 id="Microsoft_MixedReality_Toolkit_BaseCoreSystem__ctor_Microsoft_MixedReality_Toolkit_IMixedRealityServiceRegistrar_Microsoft_MixedReality_Toolkit_BaseMixedRealityProfile_" data-uid="Microsoft.MixedReality.Toolkit.BaseCoreSystem.#ctor(Microsoft.MixedReality.Toolkit.IMixedRealityServiceRegistrar,Microsoft.MixedReality.Toolkit.BaseMixedRealityProfile)">BaseCoreSystem(IMixedRealityServiceRegistrar, BaseMixedRealityProfile)</h4>
  <div class="markdown level1 summary"><p sourcefile="../../obj/api/Microsoft.MixedReality.Toolkit.BaseCoreSystem.yml" sourcestartlinenumber="2">Constructor.</p>
</div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="decalaration">Declaration</h5>
...
protected BaseCoreSystem(IMixedRealityServiceRegistrar registrar, BaseMixedRealityProfile profile = null)</code></pre>
  </div>
  <h5 class="parameters">Parameters</h5>
  <table class="table table-bordered table-striped table-condensed">
    <thead>
    ...
    <tbody>
      <tr>
        ...
        <td><p sourcefile="../../obj/api/Microsoft.MixedReality.Toolkit.BaseCoreSystem.yml" sourcestartlinenumber="1">The <a class="xref" href="Microsoft.MixedReality.Toolkit.IMixedRealityServiceRegistrar.html">IMixedRealityServiceRegistrar</a> instance that loaded the service.</p>
</td>
      </tr>
      <tr>
        <td><a class="xref" href="Microsoft.MixedReality.Toolkit.BaseMixedRealityProfile.html">BaseMixedRealityProfile</a></td>
  ...
  <a id="Microsoft_MixedReality_Toolkit_BaseCoreSystem_Registrar_" data-uid="Microsoft.MixedReality.Toolkit.BaseCoreSystem.Registrar*"></a>
  <h4 id="Microsoft_MixedReality_Toolkit_BaseCoreSystem_Registrar" data-uid="Microsoft.MixedReality.Toolkit.BaseCoreSystem.Registrar">Registrar</h4>
  <div class="markdown level1 summary"><p sourcefile="../../obj/api/Microsoft.MixedReality.Toolkit.BaseCoreSystem.yml" sourcestartlinenumber="2">The service registrar instance that registered this service.</p>
</div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="decalaration">Declaration</h5>
  <div class="codewrapper">
    <pre><code class="lang-csharp hljs">[Obsolete(&quot;The Registrar property is obsolete and will be removed in a future version of the Microsoft Mixed Reality Toolkit&quot;)]
protected IMixedRealityServiceRegistrar Registrar { get; set; }</code></pre>
  </div>
