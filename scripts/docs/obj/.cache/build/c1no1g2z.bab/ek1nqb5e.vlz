...
<html>
  ...
  <head>
    ...
    <title>Class ParabolaConstrainedLineDataProvider
   | Mixed Reality Toolkit Documentation </title>
    <meta name="viewport" content="width=device-width">
    <meta name="title" content="Class ParabolaConstrainedLineDataProvider
    ...
    <div id="wrapper">
      ...
      <div role="main" class="container body-content hide-when-search">
        ...
        <div class="article row grid-right">
          <div class="col-md-10">
            <article class="content wrap" id="_content" data-uid="Microsoft.MixedReality.Toolkit.Utilities.ParabolaConstrainedLineDataProvider">
  
  
  <h1 id="Microsoft_MixedReality_Toolkit_Utilities_ParabolaConstrainedLineDataProvider" data-uid="Microsoft.MixedReality.Toolkit.Utilities.ParabolaConstrainedLineDataProvider" class="text-break">Class ParabolaConstrainedLineDataProvider
  </h1>
  <div class="markdown level0 summary"><p sourcefile="../../obj/api/Microsoft.MixedReality.Toolkit.Utilities.ParabolaConstrainedLineDataProvider.yml" sourcestartlinenumber="2">Generates a parabolic line between two points.</p>
</div>
  ...
  <div class="inheritance">
    ...
    <div class="level2"><a class="xref" href="Microsoft.MixedReality.Toolkit.Utilities.ParabolaLineDataProvider.html">ParabolaLineDataProvider</a></div>
    <div class="level3"><span class="xref">ParabolaConstrainedLineDataProvider</span></div>
  </div>
  <div class="inheritedMembers">
    <h5>Inherited Members</h5>
    <div>
      <a class="xref" href="Microsoft.MixedReality.Toolkit.Utilities.ParabolaLineDataProvider.html#Microsoft_MixedReality_Toolkit_Utilities_ParabolaLineDataProvider_StartPoint">ParabolaLineDataProvider.StartPoint</a>
    </div>
    <div>
      <a class="xref" href="Microsoft.MixedReality.Toolkit.Utilities.ParabolaLineDataProvider.html#Microsoft_MixedReality_Toolkit_Utilities_ParabolaLineDataProvider_GetUnClampedWorldLengthInternal">ParabolaLineDataProvider.GetUnClampedWorldLengthInternal()</a>
    </div>
    <div>
      <a class="xref" href="Microsoft.MixedReality.Toolkit.Utilities.ParabolaLineDataProvider.html#Microsoft_MixedReality_Toolkit_Utilities_ParabolaLineDataProvider_GetUpVectorInternal_System_Single_">ParabolaLineDataProvider.GetUpVectorInternal(Single)</a>
    </div>
    <div>
  ...
  <h5 id="Microsoft_MixedReality_Toolkit_Utilities_ParabolaConstrainedLineDataProvider_syntax">Syntax</h5>
  <div class="codewrapper">
    <pre><code class="lang-csharp hljs">public class ParabolaConstrainedLineDataProvider : ParabolaLineDataProvider</code></pre>
  </div>
  <h3 id="properties">Properties
  </h3>
  
  
  <a id="Microsoft_MixedReality_Toolkit_Utilities_ParabolaConstrainedLineDataProvider_EndPoint_" data-uid="Microsoft.MixedReality.Toolkit.Utilities.ParabolaConstrainedLineDataProvider.EndPoint*"></a>
  <h4 id="Microsoft_MixedReality_Toolkit_Utilities_ParabolaConstrainedLineDataProvider_EndPoint" data-uid="Microsoft.MixedReality.Toolkit.Utilities.ParabolaConstrainedLineDataProvider.EndPoint">EndPoint</h4>
  <div class="markdown level1 summary"><p sourcefile="../../obj/api/Microsoft.MixedReality.Toolkit.Utilities.ParabolaConstrainedLineDataProvider.yml" sourcestartlinenumber="2">The point where this line will end.</p>
</div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="decalaration">Declaration</h5>
  <div class="codewrapper">
    <pre><code class="lang-csharp hljs">public MixedRealityPose EndPoint { get; set; }</code></pre>
  </div>
  ...
  <a id="Microsoft_MixedReality_Toolkit_Utilities_ParabolaConstrainedLineDataProvider_Height_" data-uid="Microsoft.MixedReality.Toolkit.Utilities.ParabolaConstrainedLineDataProvider.Height*"></a>
  <h4 id="Microsoft_MixedReality_Toolkit_Utilities_ParabolaConstrainedLineDataProvider_Height" data-uid="Microsoft.MixedReality.Toolkit.Utilities.ParabolaConstrainedLineDataProvider.Height">Height</h4>
  ...
  <a id="Microsoft_MixedReality_Toolkit_Utilities_ParabolaConstrainedLineDataProvider_PointCount_" data-uid="Microsoft.MixedReality.Toolkit.Utilities.ParabolaConstrainedLineDataProvider.PointCount*"></a>
  <h4 id="Microsoft_MixedReality_Toolkit_Utilities_ParabolaConstrainedLineDataProvider_PointCount" data-uid="Microsoft.MixedReality.Toolkit.Utilities.ParabolaConstrainedLineDataProvider.PointCount">PointCount</h4>
  <div class="markdown level1 summary"><p sourcefile="../../obj/api/Microsoft.MixedReality.Toolkit.Utilities.ParabolaConstrainedLineDataProvider.yml" sourcestartlinenumber="2">The number of points this line has.</p>
</div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="decalaration">Declaration</h5>
  <div class="codewrapper">
    <pre><code class="lang-csharp hljs">public override int PointCount { get; }</code></pre>
  </div>
  <h5 class="propertyValue">Property Value</h5>
  <table class="table table-bordered table-striped table-condensed">
    <thead>
  ...
  <div><a class="xref" href="Microsoft.MixedReality.Toolkit.Utilities.BaseMixedRealityLineDataProvider.html#Microsoft_MixedReality_Toolkit_Utilities_BaseMixedRealityLineDataProvider_PointCount">BaseMixedRealityLineDataProvider.PointCount</a></div>
  
  
  <a id="Microsoft_MixedReality_Toolkit_Utilities_ParabolaConstrainedLineDataProvider_UpDirection_" data-uid="Microsoft.MixedReality.Toolkit.Utilities.ParabolaConstrainedLineDataProvider.UpDirection*"></a>
  <h4 id="Microsoft_MixedReality_Toolkit_Utilities_ParabolaConstrainedLineDataProvider_UpDirection" data-uid="Microsoft.MixedReality.Toolkit.Utilities.ParabolaConstrainedLineDataProvider.UpDirection">UpDirection</h4>
  <div class="markdown level1 summary"></div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="decalaration">Declaration</h5>
  <div class="codewrapper">
    <pre><code class="lang-csharp hljs">public Vector3 UpDirection { get; set; }</code></pre>
  </div>
  <h5 class="propertyValue">Property Value</h5>
  <table class="table table-bordered table-striped table-condensed">
    <thead>
  ...
  <a id="Microsoft_MixedReality_Toolkit_Utilities_ParabolaConstrainedLineDataProvider_GetPointInternal_" data-uid="Microsoft.MixedReality.Toolkit.Utilities.ParabolaConstrainedLineDataProvider.GetPointInternal*"></a>
  <h4 id="Microsoft_MixedReality_Toolkit_Utilities_ParabolaConstrainedLineDataProvider_GetPointInternal_System_Int32_" data-uid="Microsoft.MixedReality.Toolkit.Utilities.ParabolaConstrainedLineDataProvider.GetPointInternal(System.Int32)">GetPointInternal(Int32)</h4>
  <div class="markdown level1 summary"><p sourcefile="../../obj/api/Microsoft.MixedReality.Toolkit.Utilities.ParabolaConstrainedLineDataProvider.yml" sourcestartlinenumber="2">Get a point based on point index
Point index will be pre-clamped</p>
</div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="decalaration">Declaration</h5>
  <div class="codewrapper">
    <pre><code class="lang-csharp hljs">protected override Vector3 GetPointInternal(int pointIndex)</code></pre>
  </div>
  ...
  <h5 class="overrides">Overrides</h5>
  <div><a class="xref" href="Microsoft.MixedReality.Toolkit.Utilities.BaseMixedRealityLineDataProvider.html#Microsoft_MixedReality_Toolkit_Utilities_BaseMixedRealityLineDataProvider_GetPointInternal_System_Int32_">BaseMixedRealityLineDataProvider.GetPointInternal(Int32)</a></div>
  
  
  <a id="Microsoft_MixedReality_Toolkit_Utilities_ParabolaConstrainedLineDataProvider_GetPointInternal_" data-uid="Microsoft.MixedReality.Toolkit.Utilities.ParabolaConstrainedLineDataProvider.GetPointInternal*"></a>
  <h4 id="Microsoft_MixedReality_Toolkit_Utilities_ParabolaConstrainedLineDataProvider_GetPointInternal_System_Single_" data-uid="Microsoft.MixedReality.Toolkit.Utilities.ParabolaConstrainedLineDataProvider.GetPointInternal(System.Single)">GetPointInternal(Single)</h4>
  <div class="markdown level1 summary"><p sourcefile="../../obj/api/Microsoft.MixedReality.Toolkit.Utilities.ParabolaConstrainedLineDataProvider.yml" sourcestartlinenumber="2">Get a point based on normalized distance along line
Normalized distance will be pre-clamped</p>
</div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="decalaration">Declaration</h5>
  <div class="codewrapper">
    <pre><code class="lang-csharp hljs">protected override Vector3 GetPointInternal(float normalizedDistance)</code></pre>
  </div>
  <h5 class="parameters">Parameters</h5>
  <table class="table table-bordered table-striped table-condensed">
    <thead>
    ...
    <tbody>
      <tr>
        <td><a class="xref" href="https://docs.microsoft.com/dotnet/api/system.single">Single</a></td>
        <td><span class="parametername">normalizedDistance</span></td>
        <td></td>
      </tr>
    </tbody>
  </table>
  ...
  <h5 class="overrides">Overrides</h5>
  <div><a class="xref" href="Microsoft.MixedReality.Toolkit.Utilities.BaseMixedRealityLineDataProvider.html#Microsoft_MixedReality_Toolkit_Utilities_BaseMixedRealityLineDataProvider_GetPointInternal_System_Single_">BaseMixedRealityLineDataProvider.GetPointInternal(Single)</a></div>
  
  
  <a id="Microsoft_MixedReality_Toolkit_Utilities_ParabolaConstrainedLineDataProvider_SetPointInternal_" data-uid="Microsoft.MixedReality.Toolkit.Utilities.ParabolaConstrainedLineDataProvider.SetPointInternal*"></a>
  <h4 id="Microsoft_MixedReality_Toolkit_Utilities_ParabolaConstrainedLineDataProvider_SetPointInternal_System_Int32_Vector3_" data-uid="Microsoft.MixedReality.Toolkit.Utilities.ParabolaConstrainedLineDataProvider.SetPointInternal(System.Int32,Vector3)">SetPointInternal(Int32, Vector3)</h4>
  <div class="markdown level1 summary"><p sourcefile="../../obj/api/Microsoft.MixedReality.Toolkit.Utilities.ParabolaConstrainedLineDataProvider.yml" sourcestartlinenumber="2">Sets the point at index.</p>
</div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="decalaration">Declaration</h5>
  <div class="codewrapper">
    <pre><code class="lang-csharp hljs">protected override void SetPointInternal(int pointIndex, Vector3 point)</code></pre>
  </div>
  <h5 class="parameters">Parameters</h5>
  <table class="table table-bordered table-striped table-condensed">
    <thead>
  ...
  <h5 class="overrides">Overrides</h5>
  <div><a class="xref" href="Microsoft.MixedReality.Toolkit.Utilities.BaseMixedRealityLineDataProvider.html#Microsoft_MixedReality_Toolkit_Utilities_BaseMixedRealityLineDataProvider_SetPointInternal_System_Int32_Vector3_">BaseMixedRealityLineDataProvider.SetPointInternal(Int32, Vector3)</a></div>
</article>
          </div>
