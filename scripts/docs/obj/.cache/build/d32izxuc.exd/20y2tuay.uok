...
<html>
  ...
  <head>
    ...
    <title>Class InBetween
   | Mixed Reality Toolkit Documentation </title>
    <meta name="viewport" content="width=device-width">
    <meta name="title" content="Class InBetween
    ...
    <div id="wrapper">
      ...
      <div role="main" class="container body-content hide-when-search">
        ...
        <div class="article row grid-right">
          <div class="col-md-10">
            <article class="content wrap" id="_content" data-uid="Microsoft.MixedReality.Toolkit.Utilities.Solvers.InBetween">
  
  
  <h1 id="Microsoft_MixedReality_Toolkit_Utilities_Solvers_InBetween" data-uid="Microsoft.MixedReality.Toolkit.Utilities.Solvers.InBetween" class="text-break">Class InBetween
  </h1>
  <div class="markdown level0 summary"><p sourcefile="../../obj/api/Microsoft.MixedReality.Toolkit.Utilities.Solvers.InBetween.yml" sourcestartlinenumber="2">InBetween solver positions an object in-between two tracked transforms.</p>
</div>
  ...
  <div class="inheritance">
    ...
    <div class="level2"><span class="xref">InBetween</span></div>
  </div>
  ...
  <h5 id="Microsoft_MixedReality_Toolkit_Utilities_Solvers_InBetween_syntax">Syntax</h5>
  <div class="codewrapper">
    <pre><code class="lang-csharp hljs">public class InBetween : Solver</code></pre>
  </div>
  <h3 id="properties">Properties
  </h3>
  
  
  <a id="Microsoft_MixedReality_Toolkit_Utilities_Solvers_InBetween_PartwayOffset_" data-uid="Microsoft.MixedReality.Toolkit.Utilities.Solvers.InBetween.PartwayOffset*"></a>
  <h4 id="Microsoft_MixedReality_Toolkit_Utilities_Solvers_InBetween_PartwayOffset" data-uid="Microsoft.MixedReality.Toolkit.Utilities.Solvers.InBetween.PartwayOffset">PartwayOffset</h4>
  <div class="markdown level1 summary"><p sourcefile="../../obj/api/Microsoft.MixedReality.Toolkit.Utilities.Solvers.InBetween.yml" sourcestartlinenumber="2">Distance along the center line the object will be located. 0.5 is halfway, 1.0 is at the first transform, 0.0 is at the second transform.</p>
</div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="decalaration">Declaration</h5>
  <div class="codewrapper">
    <pre><code class="lang-csharp hljs">public float PartwayOffset { get; set; }</code></pre>
  </div>
  ...
  <a id="Microsoft_MixedReality_Toolkit_Utilities_Solvers_InBetween_SecondTrackedObjectType_" data-uid="Microsoft.MixedReality.Toolkit.Utilities.Solvers.InBetween.SecondTrackedObjectType*"></a>
  <h4 id="Microsoft_MixedReality_Toolkit_Utilities_Solvers_InBetween_SecondTrackedObjectType" data-uid="Microsoft.MixedReality.Toolkit.Utilities.Solvers.InBetween.SecondTrackedObjectType">SecondTrackedObjectType</h4>
  <div class="markdown level1 summary"><p sourcefile="../../obj/api/Microsoft.MixedReality.Toolkit.Utilities.Solvers.InBetween.yml" sourcestartlinenumber="2">Tracked object to calculate position and orientation for the second object. If you want to manually override and use a scene object, use the TransformTarget field.</p>
</div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="decalaration">Declaration</h5>
  <div class="codewrapper">
    <pre><code class="lang-csharp hljs">public TrackedObjectType SecondTrackedObjectType { get; set; }</code></pre>
  </div>
  <h5 class="propertyValue">Property Value</h5>
  <table class="table table-bordered table-striped table-condensed">
    <thead>
    ...
    <tbody>
      <tr>
        <td><a class="xref" href="Microsoft.MixedReality.Toolkit.Utilities.TrackedObjectType.html">TrackedObjectType</a></td>
        <td></td>
      </tr>
    </tbody>
  </table>
  ...
  <a id="Microsoft_MixedReality_Toolkit_Utilities_Solvers_InBetween_SecondTransformOverride_" data-uid="Microsoft.MixedReality.Toolkit.Utilities.Solvers.InBetween.SecondTransformOverride*"></a>
  <h4 id="Microsoft_MixedReality_Toolkit_Utilities_Solvers_InBetween_SecondTransformOverride" data-uid="Microsoft.MixedReality.Toolkit.Utilities.Solvers.InBetween.SecondTransformOverride">SecondTransformOverride</h4>
  <div class="markdown level1 summary"><p sourcefile="../../obj/api/Microsoft.MixedReality.Toolkit.Utilities.Solvers.InBetween.yml" sourcestartlinenumber="2">This transform overrides any Tracked Object as the second point for the In Between</p>
</div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="decalaration">Declaration</h5>
  <div class="codewrapper">
    <pre><code class="lang-csharp hljs">public Transform SecondTransformOverride { get; set; }</code></pre>
  </div>
  <h5 class="propertyValue">Property Value</h5>
  <table class="table table-bordered table-striped table-condensed">
    <thead>
  ...
  <a id="Microsoft_MixedReality_Toolkit_Utilities_Solvers_InBetween_TrackedObjectForSecondTransform_" data-uid="Microsoft.MixedReality.Toolkit.Utilities.Solvers.InBetween.TrackedObjectForSecondTransform*"></a>
  <h4 id="Microsoft_MixedReality_Toolkit_Utilities_Solvers_InBetween_TrackedObjectForSecondTransform" data-uid="Microsoft.MixedReality.Toolkit.Utilities.Solvers.InBetween.TrackedObjectForSecondTransform">TrackedObjectForSecondTransform</h4>
  <div class="markdown level1 summary"><p sourcefile="../../obj/api/Microsoft.MixedReality.Toolkit.Utilities.Solvers.InBetween.yml" sourcestartlinenumber="2">Tracked object to calculate position and orientation for the second object. If you want to manually override and use a scene object, use the TransformTarget field.</p>
</div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="decalaration">Declaration</h5>
  <div class="codewrapper">
    <pre><code class="lang-csharp hljs">[Obsolete(&quot;Use SecondTrackedObjectType property instead&quot;)]
public TrackedObjectType TrackedObjectForSecondTransform { get; set; }</code></pre>
  </div>
  <h5 class="propertyValue">Property Value</h5>
  <table class="table table-bordered table-striped table-condensed">
    <thead>
  ...
  <a id="Microsoft_MixedReality_Toolkit_Utilities_Solvers_InBetween_OnValidate_" data-uid="Microsoft.MixedReality.Toolkit.Utilities.Solvers.InBetween.OnValidate*"></a>
  <h4 id="Microsoft_MixedReality_Toolkit_Utilities_Solvers_InBetween_OnValidate" data-uid="Microsoft.MixedReality.Toolkit.Utilities.Solvers.InBetween.OnValidate">OnValidate()</h4>
  <div class="markdown level1 summary"></div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="decalaration">Declaration</h5>
  <div class="codewrapper">
    <pre><code class="lang-csharp hljs">protected void OnValidate()</code></pre>
  </div>
  
  
  <a id="Microsoft_MixedReality_Toolkit_Utilities_Solvers_InBetween_SolverUpdate_" data-uid="Microsoft.MixedReality.Toolkit.Utilities.Solvers.InBetween.SolverUpdate*"></a>
  <h4 id="Microsoft_MixedReality_Toolkit_Utilities_Solvers_InBetween_SolverUpdate" data-uid="Microsoft.MixedReality.Toolkit.Utilities.Solvers.InBetween.SolverUpdate">SolverUpdate()</h4>
  <div class="markdown level1 summary"><p sourcefile="../../obj/api/Microsoft.MixedReality.Toolkit.Utilities.Solvers.InBetween.yml" sourcestartlinenumber="2">Should be implemented in derived classes, but Solver can be used to flush shared transform to real transform</p>
</div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="decalaration">Declaration</h5>
  <div class="codewrapper">
  ...
  <a id="Microsoft_MixedReality_Toolkit_Utilities_Solvers_InBetween_Start_" data-uid="Microsoft.MixedReality.Toolkit.Utilities.Solvers.InBetween.Start*"></a>
  <h4 id="Microsoft_MixedReality_Toolkit_Utilities_Solvers_InBetween_Start" data-uid="Microsoft.MixedReality.Toolkit.Utilities.Solvers.InBetween.Start">Start()</h4>
  <div class="markdown level1 summary"></div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="decalaration">Declaration</h5>
  <div class="codewrapper">
