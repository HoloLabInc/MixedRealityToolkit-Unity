...
<html>
  ...
  <head>
    ...
    <title>Interface IMixedRealityHandJointService
   | Mixed Reality Toolkit Documentation </title>
    <meta name="viewport" content="width=device-width">
    <meta name="title" content="Interface IMixedRealityHandJointService
    ...
    <div id="wrapper">
      ...
      <div role="main" class="container body-content hide-when-search">
        ...
        <div class="article row grid-right">
          <div class="col-md-10">
            <article class="content wrap" id="_content" data-uid="Microsoft.MixedReality.Toolkit.Input.IMixedRealityHandJointService">
  
  
  <h1 id="Microsoft_MixedReality_Toolkit_Input_IMixedRealityHandJointService" data-uid="Microsoft.MixedReality.Toolkit.Input.IMixedRealityHandJointService" class="text-break">Interface IMixedRealityHandJointService
  </h1>
  <div class="markdown level0 summary"><p sourcefile="../../obj/api/Microsoft.MixedReality.Toolkit.Input.IMixedRealityHandJointService.yml" sourcestartlinenumber="2">Mixed Reality Toolkit device definition, used to instantiate and manage a specific device / SDK</p>
</div>
  ...
  <h5 id="Microsoft_MixedReality_Toolkit_Input_IMixedRealityHandJointService_syntax">Syntax</h5>
  <div class="codewrapper">
    <pre><code class="lang-csharp hljs">public interface IMixedRealityHandJointService : IMixedRealityInputDeviceManager, IMixedRealityDataProvider, IMixedRealityService, IDisposable</code></pre>
  </div>
  <h3 id="methods">Methods
  </h3>
  
  
  <a id="Microsoft_MixedReality_Toolkit_Input_IMixedRealityHandJointService_IsHandTracked_" data-uid="Microsoft.MixedReality.Toolkit.Input.IMixedRealityHandJointService.IsHandTracked*"></a>
  <h4 id="Microsoft_MixedReality_Toolkit_Input_IMixedRealityHandJointService_IsHandTracked_Handedness_" data-uid="Microsoft.MixedReality.Toolkit.Input.IMixedRealityHandJointService.IsHandTracked(Handedness)">IsHandTracked(Handedness)</h4>
  <div class="markdown level1 summary"></div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="decalaration">Declaration</h5>
  <div class="codewrapper">
    <pre><code class="lang-csharp hljs">bool IsHandTracked(Handedness handedness)</code></pre>
  </div>
  ...
  <a id="Microsoft_MixedReality_Toolkit_Input_IMixedRealityHandJointService_RequestJointTransform_" data-uid="Microsoft.MixedReality.Toolkit.Input.IMixedRealityHandJointService.RequestJointTransform*"></a>
  <h4 id="Microsoft_MixedReality_Toolkit_Input_IMixedRealityHandJointService_RequestJointTransform_TrackedHandJoint_Handedness_" data-uid="Microsoft.MixedReality.Toolkit.Input.IMixedRealityHandJointService.RequestJointTransform(TrackedHandJoint,Handedness)">RequestJointTransform(TrackedHandJoint, Handedness)</h4>
  <div class="markdown level1 summary"><p sourcefile="../../obj/api/Microsoft.MixedReality.Toolkit.Input.IMixedRealityHandJointService.yml" sourcestartlinenumber="2">Get a game object following the hand joint.</p>
</div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="decalaration">Declaration</h5>
  <div class="codewrapper">
    <pre><code class="lang-csharp hljs">Transform RequestJointTransform(TrackedHandJoint joint, Handedness handedness)</code></pre>
  </div>
  <h5 class="parameters">Parameters</h5>
  <table class="table table-bordered table-striped table-condensed">
    <thead>
