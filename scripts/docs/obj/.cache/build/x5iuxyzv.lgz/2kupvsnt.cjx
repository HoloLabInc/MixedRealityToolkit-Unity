...
<html>
  ...
  <head>
    ...
    <title>Interface IMixedRealityExtensionService
   | Mixed Reality Toolkit Documentation </title>
    <meta name="viewport" content="width=device-width">
    <meta name="title" content="Interface IMixedRealityExtensionService
    ...
    <div id="wrapper">
      ...
      <div role="main" class="container body-content hide-when-search">
        ...
        <div class="article row grid-right">
          <div class="col-md-10">
            <article class="content wrap" id="_content" data-uid="Microsoft.MixedReality.Toolkit.IMixedRealityExtensionService">
  
  
  <h1 id="Microsoft_MixedReality_Toolkit_IMixedRealityExtensionService" data-uid="Microsoft.MixedReality.Toolkit.IMixedRealityExtensionService" class="text-break">Interface IMixedRealityExtensionService
  </h1>
  <div class="markdown level0 summary"><p sourcefile="../../obj/api/Microsoft.MixedReality.Toolkit.IMixedRealityExtensionService.yml" sourcestartlinenumber="2">Generic interface for all optional Mixed Reality systems, components, or features that can be added to the <a class="xref" href="Microsoft.MixedReality.Toolkit.MixedRealityServiceConfiguration.html">MixedRealityServiceConfiguration</a></p>
</div>
  ...
  <h5 id="Microsoft_MixedReality_Toolkit_IMixedRealityExtensionService_syntax">Syntax</h5>
  <div class="codewrapper">
    <pre><code class="lang-csharp hljs">public interface IMixedRealityExtensionService : IMixedRealityService, IDisposable</code></pre>
  </div>
</article>
          </div>
